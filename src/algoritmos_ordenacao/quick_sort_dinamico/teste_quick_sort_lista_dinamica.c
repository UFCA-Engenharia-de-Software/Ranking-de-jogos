...
int main(void) {
    ...
    quickSortListaDinamica(&lista, ORDENAR_PONTUACAO);
    ...
    printf("\n=== Teste 2: lista vazia ===\n");
    NoDuplo *vazia = NULL;
    quickSortListaDinamica(&vazia, ORDENAR_PONTUACAO);
    ...
    quickSortListaDinamica(&unico, ORDENAR_PONTUACAO);
    ...
    quickSortListaDinamica(&ordenada, ORDENAR_PONTUACAO);
    ...
    quickSortListaDinamica(&inversa, ORDENAR_PONTUACAO);
